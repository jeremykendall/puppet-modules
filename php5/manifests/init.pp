...
class php5 {
    ...
    exec { 'date_timezone':
        ...
        onlyif  => '/bin/grep -c ";date.timezone =" /etc/php5/apache2/php.ini',
    ...
    exec { 'short_tags_off':
        ...
        onlyif => '/bin/grep -c "short_open_tag = On" /etc/php5/apache2/php.ini',
        require => Package['php5'],
        notify  => Service['apache2']
    }
    ...
    exec { 'html_errors_on':
        ...
        onlyif => '/bin/grep -c "html_errors = Off" /etc/php5/apache2/php.ini',
        require => Package['php5'],
        notify  => Service['apache2']
    }
